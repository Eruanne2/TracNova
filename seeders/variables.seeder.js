  ...
  _generateVariables() {
    return [
      ...
      },
      {
        ...
        unit: 'rating',
        dailylogs: {
          '03/03/2021': Math.floor(Math.random() * 4) + 1,
          '01/11/2021': Math.floor(Math.random() * 4) + 1,
          '02/26/2021': Math.floor(Math.random() * 4) + 1,
          '02/17/2021': Math.floor(Math.random() * 4) + 1,
          '02/28/2021': Math.floor(Math.random() * 4) + 1,
          '01/31/2021': Math.floor(Math.random() * 4) + 1,
          '03/18/2021': Math.floor(Math.random() * 4) + 1,
          '03/21/2021': Math.floor(Math.random() * 4) + 1,
          '03/30/2021': Math.floor(Math.random() * 4) + 1,
          '02/09/2021': Math.floor(Math.random() * 4) + 1,
          '01/11/2021': Math.floor(Math.random() * 4) + 1,
          '03/16/2021': Math.floor(Math.random() * 4) + 1,
          '04/22/2021': Math.floor(Math.random() * 4) + 1,
          '01/07/2021': Math.floor(Math.random() * 4) + 1,
          '03/20/2021': Math.floor(Math.random() * 4) + 1,
          '03/20/2021': Math.floor(Math.random() * 4) + 1,
          '03/28/2021': Math.floor(Math.random() * 4) + 1,
          '02/22/2021': Math.floor(Math.random() * 4) + 1,
          '03/17/2021': Math.floor(Math.random() * 4) + 1,
          '03/09/2021': Math.floor(Math.random() * 4) + 1,
          '02/09/2021': Math.floor(Math.random() * 4) + 1,
          '01/21/2021': Math.floor(Math.random() * 4) + 1,
          '01/03/2021': Math.floor(Math.random() * 4) + 1,
          '03/04/2021': Math.floor(Math.random() * 4) + 1,
          '03/28/2021': Math.floor(Math.random() * 4) + 1,
          '02/11/2021': Math.floor(Math.random() * 4) + 1,
          '01/16/2021': Math.floor(Math.random() * 4) + 1,
          '04/12/2021': Math.floor(Math.random() * 4) + 1,
          '01/26/2021': Math.floor(Math.random() * 4) + 1,
          '01/31/2021': Math.floor(Math.random() * 4) + 1,
          '01/11/2021': Math.floor(Math.random() * 4) + 1,
          '02/01/2021': Math.floor(Math.random() * 4) + 1,
          '03/30/2021': Math.floor(Math.random() * 4) + 1,
          '01/26/2021': Math.floor(Math.random() * 4) + 1,
          '04/15/2021': Math.floor(Math.random() * 4) + 1,
          '02/09/2021': Math.floor(Math.random() * 4) + 1,
          '04/04/2021': Math.floor(Math.random() * 4) + 1,
          '01/05/2021': Math.floor(Math.random() * 4) + 1,
          '02/28/2021': Math.floor(Math.random() * 4) + 1,
          '03/27/2021': Math.floor(Math.random() * 4) + 1,
          '01/28/2021': Math.floor(Math.random() * 4) + 1,
          '03/21/2021': Math.floor(Math.random() * 4) + 1,
          '01/08/2021': Math.floor(Math.random() * 4) + 1,
          '02/06/2021': Math.floor(Math.random() * 4) + 1,
          '03/07/2021': Math.floor(Math.random() * 4) + 1,
          '04/20/2021': Math.floor(Math.random() * 4) + 1,
          '02/25/2021': Math.floor(Math.random() * 4) + 1,
          '01/29/2021': Math.floor(Math.random() * 4) + 1,
          '01/14/2021': Math.floor(Math.random() * 4) + 1,
          '03/09/2021': Math.floor(Math.random() * 4) + 1,
          '03/12/2021': Math.floor(Math.random() * 4) + 1,
          '01/12/2021': Math.floor(Math.random() * 4) + 1,
          '04/07/2021': Math.floor(Math.random() * 4) + 1,
          '04/04/2021': Math.floor(Math.random() * 4) + 1,
          '01/18/2021': Math.floor(Math.random() * 4) + 1,
          '02/25/2021': Math.floor(Math.random() * 4) + 1,
          '03/02/2021': Math.floor(Math.random() * 4) + 1,
          '04/14/2021': Math.floor(Math.random() * 4) + 1,
          '04/09/2021': Math.floor(Math.random() * 4) + 1,
          '03/09/2021': Math.floor(Math.random() * 4) + 1,
          '03/16/2021': Math.floor(Math.random() * 4) + 1,
          '04/07/2021': Math.floor(Math.random() * 4) + 1,
          '02/20/2021': Math.floor(Math.random() * 4) + 1,
          '03/20/2021': Math.floor(Math.random() * 4) + 1,
          '03/31/2021': Math.floor(Math.random() * 4) + 1,
          '02/16/2021': Math.floor(Math.random() * 4) + 1,
          '02/15/2021': Math.floor(Math.random() * 4) + 1,
          '03/04/2021': Math.floor(Math.random() * 4) + 1,
          '04/22/2021': Math.floor(Math.random() * 4) + 1,
          '04/08/2021': Math.floor(Math.random() * 4) + 1,
          '01/22/2021': Math.floor(Math.random() * 4) + 1,
          '04/23/2021': Math.floor(Math.random() * 4) + 1,
          '02/20/2021': Math.floor(Math.random() * 4) + 1,
          '03/12/2021': Math.floor(Math.random() * 4) + 1,
          '03/28/2021': Math.floor(Math.random() * 4) + 1,
          '03/02/2021': Math.floor(Math.random() * 4) + 1,
          ...
          '03/21/2021': Math.floor(Math.random() * 4) + 1,
          '03/31/2021': Math.floor(Math.random() * 4) + 1,
          '04/06/2021': Math.floor(Math.random() * 4) + 1,
          '02/07/2021': Math.floor(Math.random() * 4) + 1,
          '03/14/2021': Math.floor(Math.random() * 4) + 1,
          '03/25/2021': Math.floor(Math.random() * 4) + 1,
          '01/17/2021': Math.floor(Math.random() * 4) + 1,
          '03/10/2021': Math.floor(Math.random() * 4) + 1,
          '04/15/2021': Math.floor(Math.random() * 4) + 1,
          '03/21/2021': Math.floor(Math.random() * 4) + 1,
          '02/12/2021': Math.floor(Math.random() * 4) + 1,
          '03/02/2021': Math.floor(Math.random() * 4) + 1,
          '02/18/2021': Math.floor(Math.random() * 4) + 1,
          '03/26/2021': Math.floor(Math.random() * 4) + 1,
          '02/12/2021': Math.floor(Math.random() * 4) + 1,
          '03/21/2021': Math.floor(Math.random() * 4) + 1,
          '01/20/2021': Math.floor(Math.random() * 4) + 1,
          '03/16/2021': Math.floor(Math.random() * 4) + 1,
          '02/11/2021': Math.floor(Math.random() * 4) + 1,
          '02/15/2021': Math.floor(Math.random() * 4) + 1,
          '01/03/2021': Math.floor(Math.random() * 4) + 1,
          '01/05/2021': Math.floor(Math.random() * 4) + 1,
          '02/08/2021': Math.floor(Math.random() * 4) + 1,
        }
      },
      {
        user: this.users[0]._id,
