...
export default function MeetTheTeam() {
  return(
    <div className='meet-the-team'>
      ...
      <ul>
        <li>
          <img src={charisGinn} className="member-photo" alt="Charis Ginn, Team Lead" height="150"/>
          <h2>Charis Ginn</h2>
          <h3>Team Lead</h3>
        ...
        <li>
          <img src={chrisHong} className="member-photo" alt="Chris Hong, Backend Lead" height="150"/>
          <h2>Chris Hong</h2>
          <h3>Backend Lead</h3>
        ...
        <li>
          <img src={wenchongLai} className="member-photo" alt="Wenchong Lai, Frontend Lead" height="150"/>
          <h2>Wenchong Lai</h2>
          <h3>Frontend Lead</h3>
        ...
        <li>
          <img src={justinCheasty} className="member-photo" alt="Justin Cheasty, Graphics Lead" height="150"/>
